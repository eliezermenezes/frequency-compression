...
// Arquivos para armazenar os dados do áudio
...
// Callback para capturar os buffers e salvar em arquivos
...
int main(int argc, char *argv[]) {
    ...
    // Definir a nova taxa de amostragem para 16 kHz
    GstCaps *caps = gst_caps_new_simple("audio/x-raw", "rate", G_TYPE_INT, 16000, nullptr);
    ...
    std::cout << "Capturando e processando áudio em tempo real... Pressione Ctrl+C para parar." << std::endl;
...
// Gerar arquivos de áudio WAV a partir dos arquivos RAW
// ffmpeg -f s16le -ar 44100 -ac 1 -i audio_original.raw audio_original.wav
// ffmpeg -f s16le -ar 16000 -ac 1 -i audio_processado.raw audio_processado.wav